...
export const Navbar = memo(() => {
  ...
  const handleNavItemClick = useCallback((e: React.MouseEvent, id: string) => {
    e.preventDefault();
  ...
  return (
    <nav className={`${styles.navbar} ${scrolled ? styles.scrolled : ''}`}>
      ...
      <ul className={`${styles.navItems} ${mobileMenuOpen ? styles.open : ''}`}>
        {navItems.map((item) => (
      ...
      <div className={styles.emailButton}>
        <a href="#home" onClick={handleContactClick} aria-label="Contact via email">
